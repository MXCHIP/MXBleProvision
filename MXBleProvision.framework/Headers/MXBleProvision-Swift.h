...
#ifndef MXBLEPROVISION_SWIFT_H
#define MXBLEPROVISION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MXBleProvision",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CBPeripheral;
@class NSString;
SWIFT_PROTOCOL("_TtP14MXBleProvision22MXBleDeviceLogDelegate_")
...
@optional
- (void)mxBleProvisionStepWithProductKey:(NSString * _Nonnull)productKey deviceIdentifier:(NSString * _Nonnull)deviceIdentifier step:(NSInteger)step;
...
SWIFT_CLASS("_TtC14MXBleProvision21MXBleProvisionManager")
@interface MXBleProvisionManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) MXBleProvisionManager * _Nonnull sharedInstance;)
+ (MXBleProvisionManager * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, copy) NSArray<NSDictionary<NSString *, id> *> * _Nonnull scanDevices;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)startScanWithTimeout:(NSInteger)timeout deviceType:(NSInteger)deviceType callback:(void (^ _Nonnull)(NSArray<NSDictionary<NSString *, id> *> * _Nonnull, BOOL))callback;
- (void)stopScan;
@end
...
SWIFT_CLASS("_TtC14MXBleProvision26MXBluetoothProtocolHandler")
@interface MXBluetoothProtocolHandler : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSData;
SWIFT_CLASS("_TtC14MXBleProvision12MXEncryption")
@interface MXEncryption : NSObject
+ (NSData * _Nullable)pbkdf2WithHash:(CCPBKDFAlgorithm)hash password:(NSString * _Nonnull)password salt:(NSData * _Nonnull)salt keyByteCount:(NSInteger)keyByteCount rounds:(NSInteger)rounds SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface MXFogProvisionManager (SWIFT_EXTENSION(MXBleProvision)) <CBCentralManagerDelegate, CBPeripheralDelegate>
- (void)startScan;
- (void)stopScan;
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDiscoverPeripheral:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData RSSI:(NSNumber * _Nonnull)RSSI;
...
SWIFT_CLASS("_TtC14MXBleProvision24MXLivingProvisionManager")
@interface MXLivingProvisionManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) MXLivingProvisionManager * _Nonnull shard;)
+ (MXLivingProvisionManager * _Nonnull)shard SWIFT_WARN_UNUSED_RESULT;
+ (void)setShard:(MXLivingProvisionManager * _Nonnull)value;
@property (nonatomic, weak) id <MXBleProvisionDelegate> _Nullable provisionDelegate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setTimeOutWithTimeNum:(NSInteger)timeNum;
...
@interface MXLivingProvisionManager (SWIFT_EXTENSION(MXBleProvision)) <CBCentralManagerDelegate, CBPeripheralDelegate>
- (void)startScan;
- (void)stopScan;
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDiscoverPeripheral:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData RSSI:(NSNumber * _Nonnull)RSSI;
...
SWIFT_CLASS("_TtC14MXBleProvision23MXTMallProvisionManager")
@interface MXTMallProvisionManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) MXTMallProvisionManager * _Nonnull shard;)
+ (MXTMallProvisionManager * _Nonnull)shard SWIFT_WARN_UNUSED_RESULT;
+ (void)setShard:(MXTMallProvisionManager * _Nonnull)value;
@property (nonatomic, weak) id <MXBleProvisionDelegate> _Nullable provisionDelegate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setTimeOutWithTimeNum:(NSInteger)timeNum;
...
@interface MXTMallProvisionManager (SWIFT_EXTENSION(MXBleProvision)) <CBCentralManagerDelegate, CBPeripheralDelegate>
- (void)startScan;
- (void)stopScan;
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDiscoverPeripheral:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData RSSI:(NSNumber * _Nonnull)RSSI;
...
SWIFT_CLASS("_TtC14MXBleProvision21MXYatProvisionManager")
@interface MXYatProvisionManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) MXYatProvisionManager * _Nonnull shard;)
+ (MXYatProvisionManager * _Nonnull)shard SWIFT_WARN_UNUSED_RESULT;
+ (void)setShard:(MXYatProvisionManager * _Nonnull)value;
@property (nonatomic, weak) id <MXBleProvisionDelegate> _Nullable provisionDelegate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setTimeOutWithTimeNum:(NSInteger)timeNum;
...
@interface MXYatProvisionManager (SWIFT_EXTENSION(MXBleProvision)) <CBCentralManagerDelegate, CBPeripheralDelegate>
- (void)startScan;
- (void)stopScan;
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDiscoverPeripheral:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData RSSI:(NSNumber * _Nonnull)RSSI;
